...
const FlatListSites = () => {
    const data = [
       ...
       <Image source={require('../../www.png')} style={{width:70,height:70, marginHorizontal: 100, marginVertical: 15}} />
        <Image source={require('../../check.png')} style={{width:40,height:40, marginHorizontal: 200}} />
          </View>
        );
  return (
    <View>
